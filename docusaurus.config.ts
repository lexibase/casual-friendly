    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl:
            'https://github.com/lexibaselabs/casual-friendly/tree/master/docs/',
        },
        blog: {
          ...
          // Remove this to remove the "edit this page" links.
          editUrl:
            'https://github.com/lexibaselabs/casual-friendly/tree/master/blog/',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/lexibaselabs/casual-friendly',
          position: 'right',
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Casual-Friendly, Inc. Built with Docusaurus.`,
    },
    prism: {
      theme: undefined,
    },
